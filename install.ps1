...
Write-Host "[1/8] Installing Python dependencies..."
pip install -r requirements.txt

# 2. Run makepy
Write-Host "[2/8] Running makepy - when the window appears, click Cancel or close it..."
python -m win32com.client.makepy

# 3. Compile agent
Write-Host "[3/8] Compiling agent..."
...
# 7. Configure RDP and OpenSSH
Write-Host "[7/8] Configuring RDP and OpenSSH..."
...
Write-Host "[8/8] Configuring hosts file..."
